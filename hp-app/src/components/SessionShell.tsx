...
// Shared chrome for every /session page — same dark backdrop, drifting glow
// blobs, and header treatment as the landing and öva pages, so the practice
// flow doesn't feel like a different app once you leave /ova.
