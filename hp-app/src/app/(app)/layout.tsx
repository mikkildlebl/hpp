...
export default function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative flex flex-1 overflow-hidden bg-[#05070c] text-white">
      ...
      <div className="relative z-10 flex flex-1 flex-col overflow-y-auto">
        {children}
        <footer className="border-t border-white/10 px-6 py-6 text-center text-xs text-white/40 sm:px-12">
